...
/* package simple-genetic-algorithm-0.1.0.0 */
#ifndef VERSION_simple_genetic_algorithm
#define VERSION_simple_genetic_algorithm "0.1.0.0"
#endif /* VERSION_simple_genetic_algorithm */
#ifndef MIN_VERSION_simple_genetic_algorithm
#define MIN_VERSION_simple_genetic_algorithm(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package matplotlib-0.7.5 */
#ifndef VERSION_matplotlib
#define VERSION_matplotlib "0.7.5"
...
#define CURRENT_COMPONENT_ID "simple-genetic-algorithm-0.1.0.0-7liFpZlvKIG1mmRS1SlMnV-simple-genetic-algorithm"
